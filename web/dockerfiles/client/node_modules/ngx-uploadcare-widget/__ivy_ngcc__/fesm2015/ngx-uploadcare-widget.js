...
UcWidgetComponent.ɵfac = function UcWidgetComponent_Factory(t) { return new (t || UcWidgetComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(PLATFORM_ID)); };
UcWidgetComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: UcWidgetComponent, selectors: [["ngx-uploadcare-widget"]], inputs: { publicKey: ["public-key", "publicKey"], multiple: "multiple", multipleMax: ["multiple-max", "multipleMax"], multipleMin: ["multiple-min", "multipleMin"], imagesOnly: ["images-only", "imagesOnly"], previewStep: ["preview-step", "previewStep"], crop: "crop", imageShrink: ["image-shrink", "imageShrink"], clearable: "clearable", tabs: "tabs", inputAcceptTypes: ["input-accept-types", "inputAcceptTypes"], preferredTypes: ["preferred-types", "preferredTypes"], systemDialog: ["system-dialog", "systemDialog"], secureSignature: ["secure-signature", "secureSignature"], secureExpire: ["secure-expire", "secureExpire"], value: "value", validators: "validators", cdnBase: ["cdn-base", "cdnBase"], doNotStore: ["do-not-store", "doNotStore"] }, outputs: { onUploadComplete: "on-upload-complete", onChange: "on-change", onProgress: "on-progress" }, decls: 0, vars: 0, template: function UcWidgetComponent_Template(rf, ctx) { }, encapsulation: 2 });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(UcWidgetComponent, [{
        type: Component,
        args: [{
            ...
            type: Input,
            args: ['input-accept-types']
        }], preferredTypes: [{
            type: Input,
            args: ['preferred-types']
        }], systemDialog: [{
            type: Input,
            args: ['system-dialog']
        }], secureSignature: [{
            type: Input,
            args: ['secure-signature']
        }], secureExpire: [{
            type: Input,
            args: ['secure-expire']
        }], value: [{
...
UcWidgetCustomComponent.ɵfac = function UcWidgetCustomComponent_Factory(t) { return new (t || UcWidgetCustomComponent)(ɵngcc0.ɵɵdirectiveInject(PLATFORM_ID)); };
UcWidgetCustomComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: UcWidgetCustomComponent, selectors: [["ngx-uploadcare-widget-custom"]], inputs: { publicKey: ["public-key", "publicKey"], validators: "validators", multiple: "multiple", multipleMax: ["multiple-max", "multipleMax"], multipleMin: ["multiple-min", "multipleMin"], imagesOnly: ["images-only", "imagesOnly"], previewStep: ["preview-step", "previewStep"], crop: "crop", imageShrink: ["image-shrink", "imageShrink"], clearable: "clearable", tabs: "tabs", inputAcceptTypes: ["input-accept-types", "inputAcceptTypes"], preferredTypes: ["preferred-types", "preferredTypes"], systemDialog: ["system-dialog", "systemDialog"], secureSignature: ["secure-signature", "secureSignature"], secureExpire: ["secure-expire", "secureExpire"], value: "value", cdnBase: ["cdn-base", "cdnBase"], doNotStore: ["do-not-store", "doNotStore"] }, outputs: { onUploadComplete: "on-upload-complete", onChange: "on-change", onProgress: "on-progress" }, decls: 0, vars: 0, template: function UcWidgetCustomComponent_Template(rf, ctx) { }, encapsulation: 2 });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(UcWidgetCustomComponent, [{
        type: Component,
        args: [{
...
UcWidgetModule.ɵfac = function UcWidgetModule_Factory(t) { return new (t || UcWidgetModule)(); };
UcWidgetModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: UcWidgetModule });
UcWidgetModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [], imports: [[]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(UcWidgetModule, [{
        type: NgModule,
        args: [{
                declarations: [
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(UcWidgetModule, { declarations: [UcWidgetCustomComponent, UcWidgetComponent], exports: [UcWidgetCustomComponent, UcWidgetComponent] }); })();
