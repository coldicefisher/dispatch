...
@Component({
  selector: 'RightHomePanel',
  templateUrl: './right-home-panel.component.html',
  styleUrls: ['./right-home-panel.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class RightHomePanelComponent implements OnInit {
