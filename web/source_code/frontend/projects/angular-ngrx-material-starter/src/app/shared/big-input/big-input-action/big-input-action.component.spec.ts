...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<bizniz-big-input-action></bizniz-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<bizniz-big-input-action [disabled]="true"></bizniz-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<bizniz-big-input-action fontSet="fas" fontIcon="trash"></bizniz-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<bizniz-big-input-action label="delete"></bizniz-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<bizniz-big-input-action (action)="actionHandler()"></bizniz-big-input-action>';
    fixture = createHostComponent(template);
