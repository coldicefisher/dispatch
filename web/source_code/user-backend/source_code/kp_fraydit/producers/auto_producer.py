...
class AutoProducer(BaseProducer):
    def __init__(self, topic_name: str, include_value_fields: list = None, include_key_fields: list = None) -> None:
        ...
        super().__init__(topic_name, value_schema=value_schema, key_schema=key_schema, include_value_fields=include_value_fields, include_key_fields=include_key_fields)
